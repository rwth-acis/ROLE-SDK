 ...
 * @memberOf gadgets.openapp
 */
gadgets.openapp.connect = function(callback) {
	doCallback = callback;
	if (usePubSub) {
 ...
 * @memberOf gadgets.openapp
 */
gadgets.openapp.publish = function(envelope, message) {
	envelope.event = envelope.event || "select";
	envelope.type = envelope.type || "namespaced-properties";
