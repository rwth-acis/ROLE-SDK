...
//					}
			...
			/*	// Bazaar wishing functionality
				...
				if (!$(document.body).is(".user-profile")) {
					...
					if (w != null) {
						widgetdiv.css("width", ""+w+"px;"," height", ""+h+"px");
					}
					
					widgetdiv.resizable({
						minHeight: widget._widget.metadata.modulePrefs.height,
						start : function(a,b) {
							widgetdiv.find("iframe").attr("height", "100%");
