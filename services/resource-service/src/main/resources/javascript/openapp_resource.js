	...
	request.onreadystatechange = function () {
		if (request.readyState === 4) {
			var context = {
				...
				link: request.getResponseHeader("link") !== null ? parseLinkHeader(request.getResponseHeader("link")).rels : {}
			};
			if (request.getResponseHeader("location") !== null) {
				context.uri = request.getResponseHeader("location");
			} else if (request.getResponseHeader("content-base") !== null) {
			...
			if (request.getResponseHeader("content-location") !== null) {
